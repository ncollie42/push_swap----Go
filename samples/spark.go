...
func main() {
	...
	data := []float64{4, 2, 1, 6, 3, 9, 1, 4, 2, 15, 14, 9, 8, 6, 10, 13, 15, 12, 10, 5, 3, 6, 1, 7, 10, 10, 14, 13, 17}
	data2 := []float64{1, 2, 3, 4, 28}
	...
	slg0.SetRect(0, 0, 100, 10) //x1, y1, x2, y2 int
